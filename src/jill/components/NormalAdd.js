...
function NormalAdd(props) {
  ...
  async function addUserToSever() {
    ...
    // 連接的伺服器資料網址
    const url =
      'https://safe-reaches-81172.herokuapp.com/https://honki-books.herokuapp.com/normal-index/add'
  ...
  const handleSubmit = async (e) => {
    ...
    const url =
      'https://safe-reaches-81172.herokuapp.com/https://honki-books.herokuapp.com/normal-index/picture-upload'
