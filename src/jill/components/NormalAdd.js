...
function NormalAdd(props) {
  ...
  async function addUserToSever() {
    ...
    // 連接的伺服器資料網址
    const url = 'https://cors-anywhere.herokuapp.com/https://honki-books.herokuapp.com/normal-index/add'
  ...
  const handleSubmit = async (e) => {
    ...
    const url = 'https://cors-anywhere.herokuapp.com/https://honki-books.herokuapp.com/normal-index/picture-upload'
