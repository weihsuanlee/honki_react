      ...
      <div className="container-fluid my-5">
        ...
        <div className="jill-random-success-area">
          ...
          <div className="jill-postcard d-flex justify-content-center">
            {/* <!-- 明信片底圖 --> */}
            <img
              src="http://http://wizardly-bassi-d73330.netlify.app/images/jill/postcard-random.png"
              alt=""
            />
            {/* <!-- 抽中的書 --> */}
            <div className="jill-random-success-book">
              {/* 隨機的真圖 */}
              <img
                src={`http://http://wizardly-bassi-d73330.netlify.app/images/books/` + book_pics}
                alt=""
              />
              {/* 測試時的假圖 */}
              {/* <img
                src="http://http://wizardly-bassi-d73330.netlify.app/images/books/5fe29d1d6361c.png"
                alt=""
              /> */}
            </div>
            {/* <!-- 抽中的訊息 --> */}
