  ...
  useEffect(() => {
    ...
    drop.addEventListener('drop', (event) => {
      ...
      newbookshelf.setAttribute(
        'src',
        'http://http://wizardly-bassi-d73330.netlify.app/images/yu/vip-bookshelf.png'
      )
      bodyForVip.style.background = `url('http://http://wizardly-bassi-d73330.netlify.app/images/bg_noise.png') #1c1b1b`
      ...
      setTimeout(function () {
        Swal.fire({
          ...
          imageUrl: 'http://http://wizardly-bassi-d73330.netlify.app/images/yu/mushroom-2.gif',
          imageWidth: 250,
          imageHeight: 250,
          imageAlt: 'logo',
          ...
          <Row className="d-flex justify-content-between yu-booksss">
            <Col className="yu-book-general-bookshelf col-8 ">
              ...
              <img
                ...
                src="http://http://wizardly-bassi-d73330.netlify.app/images/yu/general-bookshelf.png"
                alt=""
              />
            </Col>
            <div className="col-4">
              ...
              <div className="yu-book-new-book text-center">
                ...
                <div className="yu-book-new-book-pic mx-auto" draggable="true">
                  <img
                    src="http://http://wizardly-bassi-d73330.netlify.app/images/books/5fe422ca006c3.jpg"
                ...
                <div className="yu-book-ladybug">
                  <img
                    className="w-100"
                    src="http://http://wizardly-bassi-d73330.netlify.app/images/yu/ladybug.svg"
                    alt=""
                  />
                </div>
              </div>
