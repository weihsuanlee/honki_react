...
function Register(props) {
  ...
  const register = async function () {
    ...
    if (data.success) {
      ...
      Swal.fire({
        position: 'center',
        imageUrl: 'http://https://wizardly-bassi-d73330.netlify.app/images/yu/mushroom-1.gif',
        imageWidth: 250,
      ...
      Swal.fire({
        position: 'center',
        imageUrl: 'http://https://wizardly-bassi-d73330.netlify.app/images/components/logo.svg',
        imageWidth: 50,
        imageHeight: 50,
        html: '<b>電子信箱重複囉</b>',
        showConfirmButton: false,
          ...
          <div className="form-width-height yu-register-form">
            ...
            <div className="yu-register-bookspage">
              <img
                ...
                src="http://https://wizardly-bassi-d73330.netlify.app/images/yu/book-register.jpg"
                alt=""
              />
            </div>
            <div>
