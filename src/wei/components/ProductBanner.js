        ...
        <div className="row wei-bg-black">
          ...
          <div className="col-12 px-0">
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe1e6b4a812e.png"
                alt=""
              />
            </div>
            {/* <!-- 2 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5ffd774fed874.jpg"
                alt=""
              />
            </div>
            {/* <!-- 3 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe1e25e7712a.png"
                alt=""
              />
            </div>
            {/* <!-- 4 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5ffd4315e718e.png"
                alt=""
              />
            </div>
            {/* <!-- 5 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5ffd76f536e17.jpg"
                alt=""
              />
            </div>
            {/* <!-- 6 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe1ece65a1ed.jpg"
                alt=""
              />
            </div>
            {/* <!-- 7 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe2b8f3e050e.jpg"
                alt=""
              />
            </div>
            {/* <!-- 8 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5ffd494742e81.jpg"
                alt=""
              />
            </div>
            {/* <!-- 9 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5ffd8432b6bea.png"
                alt=""
              />
            </div>
            {/* <!-- 10 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe424a314978.png"
                alt=""
              />
            </div>
            {/* <!-- 11 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe3efd8f1856.jpg"
                alt=""
              />
            </div>
            {/* <!-- 12 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5ff2c60b2dd5d.jpg"
                alt=""
              />
            </div>
            {/* <!-- 13 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5ffd6044c062c.jpg"
                alt=""
              />
            </div>
            {/* <!-- 14 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe44c4c1f286.png"
                alt=""
              />
            </div>
            {/* <!-- 15 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe4544c89b6f.jpg"
                alt=""
              />
            </div>
            {/* <!-- 16 --> */}
            ...
            >
              <img
                className="w-100"
                src="https://honki-books.netlify.app/images/books/5fe47b1418006.png"
                alt=""
              />
            </div>
          </div>
