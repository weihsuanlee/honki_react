    ...
    <Popover id="popover-basic" className="wei-popover wei-share-pop">
      <Popover.Content style={{ fontSize: '24px' }}>
        <div
          onClick={() => {
            window.open(
              `https://twitter.com/intent/tweet?url=http://http://wizardly-bassi-d73330.netlify.app/products/${productDetail.sid}%0A&hashtags=HONKI,本気&text=Check%20out%20this%20book!📗📕📘%0A%27${productDetail.title}%27%0A推薦這本書👍👍%0A%0A`,
              '_blank'
            )
          }}
        ...
        <div
          ...
          onClick={() => {
            navigator.clipboard.writeText(
              `http://http://wizardly-bassi-d73330.netlify.app/products/` + productDetail.sid
            )
            copyButtonClick()
          }}
        >
