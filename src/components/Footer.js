    ...
    <>
      <footer className="desktopfooter">
        <div className="top d-flex">
          <img
            src="http://http://wizardly-bassi-d73330.netlify.app/images/components/footeritem.svg"
            width="185px"
            height="118px"
            alt=""
          />
          ...
          <div className="row justify-content-around footer_head">
            <div className="footer-info d-flex flex-cloumn col-12 col-md">
              <Link to="/" className="logo">
                <img
                  src="http://http://wizardly-bassi-d73330.netlify.app/images/components/logo.svg"
                  width="72px"
                  height="55px"
                  alt=""
                />
