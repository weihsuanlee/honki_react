...
function ChiaEditor(){
    ...
    return(
        <>
            <div className="chia_editorselect" data-aos="fade-up" data-aos-easing="ease-in-out">
            <div className="chia_editcircle" >
                   <img src={chiaEditcircle} />
            </div>
                <div className="container-fluid">
                    <div className="editrow row">
                        <div className="editorheader mx-auto">
                            <p>編輯推薦</p>
                        </div>
                    </div>
                    <div className="selectbox row mx-auto">
                        <div className="selecttitle d-flex justify-content-around align-items-center">
                        <div className="chia_effect d-flex flex-column justify-content-center text-center">
                                <p className="spring" onMouseEnter={() => {setIsSpring(true)
                                    setIsExam(false)
                                    setIsDiscount(false)
                                    setIsTravel(false)
                                    setIsInterview(false)}} >學生初春必讀</p>
                            <div className="chia_effectname"></div>
                            </div>
                            <p className="interview" onMouseEnter={() => {setIsInterview(true)
                             setIsSpring(false)
                                setIsExam(false)
                                setIsDiscount(false)
                                setIsTravel(false)}}>年後面試好書</p>
                            <p className="travel" onMouseEnter={() => {
                                setIsTravel(true)
                                setIsDiscount(false)
                                setIsExam(false)
                            ...
                            <p className="onlinebook" onMouseEnter={() => {
                                setIsDiscount(true)
                                setIsTravel(false)
                                setIsInterview(false)
                                setIsSpring(false)
                        ...
                        <ChiaSelectbook isspring={isspring} setIsSpring={setIsSpring} isInterview={isInterview} setIsInterview={setIsInterview} isTravel={isTravel} setIsTravel={setIsTravel} isDiscount={isDiscount} isExam={isExam}/>
                                    </div>
                                </div>
