...
function Chiasolar(){
    ...
    return(
        <>
            <div class="pastsolar">
                <div class="container">
                    <div class="pastsl row">
                        <div class="pastslheader"  data-aos="fade-down">
                            <p>過往節氣</p>
                        </div>
                    </div>
                    <div class="solarterm row justify-content-center">
                        <div class="haru d-flex" data-aos="fade-left">
                    ...
                    <div class="natsu d-flex" data-aos="fade-right">
                    ...
                    <div class="aki d-flex" data-aos="fade-left">
                     ...
                     <div class="fuyu d-flex" data-aos="fade-right">
