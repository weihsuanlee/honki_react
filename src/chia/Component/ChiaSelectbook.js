...
function ChiaSelectbook(props){
    ...
    useEffect(()=>{
        $('.chia_slidebtn-l').on('click', function(){
            $('.chia_selectbook').css({left: '0px', transition: '1.5s' })
        })
        $('.chia_slidebtn-r').on('click', function(){
         
            $('.chia_selectbook').css({ left: '-1190px', transition: '1.5s' })
        })
    },[])
    ...
    return(
        <>
            <div className="chia_slidebtn-l">
                <div className="arrowbtn  d-flex align-items-center justify-content-center " >
                    <BsChevronLeft />
                </div>
            </div>
        <div className="chia_book_editor mt-4">
               
            <div className="chia_selectbook d-flex " >
               
                <Chiaeditorbook image={bookimage1} price={price01} name={bookname1} discount={discount1}/>
                <Chiaeditorbook image={bookimage2} price={price02} name={bookname2} discount={discount2}/>
                <Chiaeditorbook image={bookimage3} price={price03} name={bookname3} discount={discount3}/>
                <Chiaeditorbook image={bookimage4} price={price04} name={bookname4} discount={discount4}/>
                <Chiaeditorbook image={bookimage5} price={price05} name={bookname5} discount={discount5}/>
                <Chiaeditorbook image={bookimage6} price={price06} name={bookname6} discount={discount6}/>
                <Chiaeditorbook image={bookimage7} price={price07} name={bookname7} discount={discount7}/>
                <Chiaeditorbook image={bookimage8} price={price08} name={bookname8} discount={discount8}/>
            ...
            <div className="chia_slidebtn-r">
                <div className="arrowbtn  d-flex align-items-center justify-content-center chia_arrowbtnr">
                    <BsChevronRight />
                </div>
            </div>
        </>
